...
| Long default exact-story request (session 2025-05-19, chunk_tokens=512) | `artifacts/story_4k_exact_request_nostream.json` | 55555 | Completed, 1932 tokens, `stop_reason=context_limit`, saved to `artifacts/story_4k_exact_current_status_new_text.txt` | SHA `6da85c62d12eb6ee49251a894f454f061b076247f65ae46bb09faa3e6f43645f`. Matches helical-off baseline — both always stop at 2048-token KV limit in the standalone server path (helical shift lives only in library path). Deterministic across sessions. |
| Long default exact-story request (prior session, chunk_tokens=32768) | `artifacts/story_4k_exact_request_nostream.json` | 55555 | Completed | SHA `6cf24939e3afcc889332d0daed2aa735b2271a7d2f996dbd17db6cb25d660636` — different from current baseline because chunk_tokens=32768 caused different fp32 accumulation paths. **Stale baseline, superseded.** |
| Long helical-off exact-story request (prior session, dead task) | `artifacts/story_4k_exact_request_nostream.json` via `8081` with `SHIMMY_DISABLE_HELICAL_SHIFT=1` | 55555 | Completed, `stop_reason=context_limit` | SHA `6da85c62d12eb6ee49251a894f454f061b076247f65ae46bb09faa3e6f43645f`. SHIMMY_DISABLE_HELICAL_SHIFT was never read by the server binary — this was identical to default path. **Task removed.** |
