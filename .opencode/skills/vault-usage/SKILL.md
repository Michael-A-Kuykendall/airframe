---
description: Using the golden reference vault to verify inference correctness
---
...
SELECT o.layer_idx, o.operation, o.expected_rms, o.expected_nan
FROM layer_oracles o JOIN models m ON o.model_id = m.id
WHERE m.name LIKE '%Llama%1B%'
ORDER BY o.layer_idx, o.operation;
"
```
