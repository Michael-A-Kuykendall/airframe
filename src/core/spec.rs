...
pub struct ModelSpec {
    ...
    /// PLE (Per-Layer Embedding) per-layer tensors; 0 = absent.
    pub ple_inp_gate_offset: u64,
    pub ple_inp_gate_quant: u32,
    pub ple_proj_offset: u64,
    pub ple_proj_quant: u32,
    pub ple_layer_output_scale_offset: u64,
    ...
    /// PLE (Per-Layer Embedding) pipeline enabled (gemma-4 dense-latent).
...
impl ModelSpec {
    ...
    pub fn from_gguf_metadata(metadata: &HashMap<String, GgufValue>) -> Self {
        ...
        Self {
            ...
            ple_enabled: false,       // set from tensor presence in metadata.rs
