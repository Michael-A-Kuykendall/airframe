...
fn all_known_specs_temp_buffer_sufficient() {
    ...
    let specs: Vec<(&str, ModelSpec)> =
        vec![("TinyLlama-1.1B", ModelSpec::tinylama_1_1b_chat_v1_0())];
...
fn temp_buffer_formula_is_monotone_in_model_size() {
    ...
    let small = ModelSpec {
        ...
        ff_dim: 5632,
        rms_eps: 1e-5,
        norm_kind: airframe::core::spec::NormKind::Rms,
        rope_base: 10000.0,
        rope_scale: 1.0,
        rope_dim: 64,
        yarn_alpha: 1.0,
        ...
        model_name: "small_test".to_string(),
        chat_template: None,
        temp_buffer_size: 0,
    ...
    let large = ModelSpec {
        ...
        arch: ModelArch::Llama,
        file_type: GgufFileType::Q4_0,
        model_name: "large_test".to_string(),
        chat_template: None,
        temp_buffer_size: 0,
        kv_cache_size_per_layer: 0,
    }
    ...
    assert!(
        ...
        large.temp_buffer_size,
        small.temp_buffer_size
    );
