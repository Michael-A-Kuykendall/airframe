...
fn build_math_pack() -> FseMap {
    let rules: Vec<Rule> = vec![
        ...
        Rule::new(
            b"what percent of users prefer",
            FseOpcode::Reject(RULE_SUPPRESS),
        ),
...
fn corpus() -> Vec<Sample> {
    vec![
        ...
        Sample {
            text: "what is 48 times 52?",
            expect_math: true,
            label: "TP-01 multiplication word",
        },
        Sample {
            text: "calculate 1000 minus 1",
            expect_math: true,
            label: "TP-02 subtraction",
        },
        Sample {
            text: "what is 25% of 200?",
            expect_math: true,
            label: "TP-03 percentage",
        },
        Sample {
            text: "how much is 7 multiplied by 8?",
            expect_math: true,
            label: "TP-04 multiplied by",
        },
        Sample {
            text: "what is the sum of 15 and 23?",
            expect_math: true,
            label: "TP-05 sum of",
        },
        Sample {
            text: "divide 100 by 4 and tell me the answer",
            expect_math: true,
            label: "TP-06 divide",
        },
        Sample {
            text: "if i have 3 groups of 12, how many total?",
            expect_math: true,
            label: "TP-07 how many total",
        },
        Sample {
            text: "the product of 6 and 9 is?",
            expect_math: true,
            label: "TP-08 product of",
        },
        Sample {
            text: "square root of 144?",
            expect_math: true,
            label: "TP-09 square root",
        },
        Sample {
            text: "what is 2 to the power of 10?",
            expect_math: true,
            label: "TP-10 power of",
        },
        Sample {
            text: "compute the average of 10, 20, and 30",
            expect_math: true,
            label: "TP-11 compute",
        },
        Sample {
            text: "what is 15% off $240?",
            expect_math: true,
            label: "TP-12 percent off",
        },
        Sample {
            text: "how many are left if i subtract 7 from 50?",
            expect_math: true,
            label: "TP-13 subtract",
        },
        Sample {
            text: "37 times 4",
            expect_math: true,
            label: "TP-14 bare expression",
        },
        Sample {
            text: "999 plus 1",
            expect_math: true,
            label: "TP-15 bare plus",
        },
        Sample {
            text: "6 divided by 2",
            expect_math: true,
            label: "TP-16 bare divide",
        },
        Sample {
            text: "what is 77 × 77?",
            expect_math: true,
            label: "TP-17 unicode times",
        },
        Sample {
            text: "evaluate 3 + 4 * 2",
            expect_math: true,
            label: "TP-18 evaluate",
        },
        Sample {
            text: "what percent of 80 is 20?",
            expect_math: true,
            label: "TP-19 what percent",
        },
        Sample {
            text:
                "if a train travels 60 miles per hour for 3 hours, how many miles does it travel?",
            expect_math: true,
            label: "TP-20 word problem",
        },
        // Output-context triggers
        Sample {
            text: "48 × 52 = ",
            expect_math: true,
            label: "TP-21 output = cue",
        },
        Sample {
            text: "the total is 3 times 12 equals ",
            expect_math: true,
            label: "TP-22 output equals cue",
        },
        Sample {
            text: "48 times 52 equals ",
            expect_math: true,
            label: "TP-23 output times equals",
        },
        Sample {
            text: "100 divided by 4 = ",
            expect_math: true,
            label: "TP-24 output divide = cue",
        },
        Sample {
            text: "the square root of 144 equals ",
            expect_math: true,
            label: "TP-25 output sqrt equals",
        },
        // ── TRUE NEGATIVES — must NOT detect ────────────────────────────────
        Sample {
            text: "the new york times reported a 30% increase",
            expect_math: false,
            label: "TN-01 newspaper",
        },
        Sample {
            text: "how many times have you tried this?",
            expect_math: false,
            label: "TN-02 frequency",
        },
        Sample {
            text: "what is the difference between tcp and udp?",
            expect_math: false,
            label: "TN-03 conceptual diff",
        },
        Sample {
            text: "tell me about the sum of human knowledge",
            expect_math: false,
            label: "TN-04 metaphor sum",
        },
        Sample {
            text: "the product launch was a success",
            expect_math: false,
            label: "TN-05 product noun",
        },
        Sample {
            text: "plus, i think you should reconsider",
            expect_math: false,
            label: "TN-06 discourse plus",
        },
        Sample {
            text: "the minus tide exposed the rocks",
            expect_math: false,
            label: "TN-07 minus tide",
        },
        Sample {
            text: "calculate your own opinion on this matter",
            expect_math: false,
            label: "TN-08 metaphor calculate",
        },
        Sample {
            text: "she was less than average in height",
            expect_math: false,
            label: "TN-09 comparison less than",
        },
        Sample {
            text: "i went to paris times two this year",
            expect_math: false,
            label: "TN-10 casual times",
        },
        Sample {
            text: "divide and conquer is a useful algorithm strategy",
            expect_math: false,
            label: "TN-11 divide and conquer",
        },
        Sample {
            text: "she is a fraction of his size",
            expect_math: false,
            label: "TN-12 metaphor fraction",
        },
        Sample {
            text: "the average person walks 8000 steps a day",
            expect_math: false,
            label: "TN-13 average adj no request",
        },
        Sample {
            text: "what percent of users prefer dark mode?",
            expect_math: false,
            label: "TN-14 no numbers",
        },
        Sample {
            text: "how much do you know about physics?",
            expect_math: false,
            label: "TN-15 how much no numbers",
        },
        Sample {
            text: "the financial times published this yesterday",
            expect_math: false,
            label: "TN-16 financial times",
        },
        Sample {
            text: "last time i checked, this was fine",
            expect_math: false,
            label: "TN-17 last time",
        },
        Sample {
            text: "next time, try a different approach",
            expect_math: false,
            label: "TN-18 next time",
        },
        Sample {
            text: "every time the server restarts, it loses state",
            expect_math: false,
            label: "TN-19 every time",
        },
        Sample {
            text: "plus one to your account for the referral",
            expect_math: false,
            label: "TN-20 plus one idiom",
        },
        Sample {
            text: "the sum total of evidence is unclear",
            expect_math: false,
            label: "TN-21 sum total idiom",
        },
        Sample {
            text: "over the course of three years",
            expect_math: false,
            label: "TN-22 over preposition",
        },
        Sample {
            text: "she ran over the estimate by a bit",
            expect_math: false,
            label: "TN-23 ran over preposition",
        },
        Sample {
            text: "times have changed",
            expect_math: false,
            label: "TN-24 times plural noun",
        },
        Sample {
            text: "the times of india",
            expect_math: false,
            label: "TN-25 times of india",
        },
    ]
}
...
fn fuzz_corpus() -> Vec<Sample> {
    vec![
        ...
        Sample {
            text: "sometimes 3 times 4 is useful",
            expect_math: true,
            label: "FZ-A1 sometimes→times REAL MATH",
        },
        Sample {
            text: "oftentimes the answer is 12",
            expect_math: false,
            label: "FZ-A2 oftentimes no-arith",
        },
        Sample {
            text: "lifetimes of work equal 80 years",
            expect_math: false,
            label: "FZ-A3 lifetimes no-arith",
        },
        Sample {
            text: "bedtimes stories with 5 plus 3",
            expect_math: true,
            label: "FZ-A4 bedtimes REAL MATH 5+3",
        },
        Sample {
            text: "at times 9 divided by 3 is relevant",
            expect_math: true,
            label: "FZ-A5 at times REAL MATH 9÷3",
        },
        ...
        Sample {
            text: "for times square root of 16 seems big",
            expect_math: true,
            label: "FZ-A6 for times + sqrt(16)",
        },
        // ── B. Metaphor / Non-compute "equals / result / total / answer" ─────
        // With ≥2 integers present — survives guard, must be suppressed.
        Sample {
            text: "in this company success equals hard work and 100 percent dedication",
            expect_math: false,
            label: "FZ-B1 success equals + 2 nums",
        },
        Sample {
            text: "the only result is more testing and 2x the effort",
            expect_math: false,
            label: "FZ-B2 result is + 2 implies",
        },
        Sample {
            text: "total is what matters in 5 years",
            expect_math: false,
            label: "FZ-B3 total is non-arith 1 num",
        },
        Sample {
            text: "the answer is always more discipline",
            expect_math: false,
            label: "FZ-B4 the answer is always 0 nums",
        },
        Sample {
            text: "happiness equals 42 in this movie reference",
            expect_math: false,
            label: "FZ-B5 equals 42 metaphor 1 num",
        },
        // ── C. Discourse / Preposition Attacks ───────────────────────────────
        Sample {
            text: "per your last email please calculate 25 plus 17",
            expect_math: true,
            label: "FZ-C1 per your — REAL MATH 25+17",
        },
        Sample {
            text: "per the new policy divide 100 by 4",
            expect_math: true,
            label: "FZ-C2 per the — REAL MATH 100÷4",
        },
        Sample {
            text: "out of curiosity what is 8 times 9",
            expect_math: true,
            label: "FZ-C3 out of curiosity REAL MATH",
        },
        Sample {
            text: "out of options i have 3 choices left",
            expect_math: false,
            label: "FZ-C4 out of options non-arith",
        },
        Sample {
            text: "evaluate this proposal with 4 new features",
            expect_math: false,
            label: "FZ-C5 evaluate this non-math",
        },
        // ── D. Verb Collision (evaluate / compute / add) ─────────────────────
        Sample {
            text: "we need to evaluate the 3 options and pick 2",
            expect_math: false,
            label: "FZ-D1 evaluate the options",
        },
        Sample {
            text: "compute resources cost 120 dollars per month",
            expect_math: false,
            label: "FZ-D2 compute resources cloud",
        },
        Sample {
            text: "add this to the 5 existing tickets",
            expect_math: false,
            label: "FZ-D3 add to tickets non-arith",
        },
        ...
        Sample {
            text: "what is 3+4",
            expect_math: true,
            label: "FZ-E1 no-space 3+4",
        },
        Sample {
            text: "solve 48*52",
            expect_math: true,
            label: "FZ-E2 no-space 48*52",
        },
        Sample {
            text: "calculate 100/4",
            expect_math: true,
            label: "FZ-E3 no-space 100/4",
        },
        Sample {
            text: "77×77",
            expect_math: true,
            label: "FZ-E4 no-space ×",
        },
        Sample {
            text: "x=5+3",
            expect_math: true,
            label: "FZ-E5 no-space x=5+3",
        },
        ...
        Sample {
            text: "how many times have you seen 12 plus 8",
            expect_math: false,
            label: "FZ-F1 how-many-times-have temporal",
        },
        // FZ-F2: clause splitter isolates "what is 15 times 4" from "financial times" clause
        Sample {
            text: "the financial times reported 30 percent growth but what is 15 times 4",
            expect_math: true,
            label: "FZ-F2 FT clause-split: 15 times 4 detected",
        },
        // FZ-F3: "sometimes " suppress REMOVED — "calculate 9 minus 2" now reachable.
        Sample {
            text: "sometimes the answer is 7 but calculate 9 minus 2",
            expect_math: true,
            label: "FZ-F3 sometimes removed, 9-2 reachable",
        },
        // ── G. Big-O / Complexity / Technical Writing ────────────────────────
        Sample {
            text: "this runs in o(n squared) time with 2 parameters",
            expect_math: false,
            label: "FZ-G1 O(n^2) description",
        },
        Sample {
            text: "squared complexity appears when n is 1000",
            expect_math: false,
            label: "FZ-G2 squared complexity 1 num",
        },
        // ── H. Headcount / Non-arithmetic "how many / what is" ───────────────
        // Zero digit-integers — guard kills these cleanly.
        Sample {
            text: "how many people live in kansas city in 2026",
            expect_math: false,
            label: "FZ-H1 headcount 1 num",
        },
        Sample {
            text: "what is the population of tokyo",
            expect_math: false,
            label: "FZ-H2 population 0 nums",
        },
        Sample {
            text: "how many employees does the company have",
            expect_math: false,
            label: "FZ-H3 employee count 0 nums",
        },
        // ── I. Output-context false triggers ─────────────────────────────────
        Sample {
            text: "the final result is always the same regardless of input",
            expect_math: false,
            label: "FZ-I1 result is always 0 nums",
        },
        Sample {
            text: "total is the only metric that equals success",
            expect_math: false,
            label: "FZ-I2 total equals success 0 nums",
        },
        Sample {
            text: "the answer is: culture",
            expect_math: false,
            label: "FZ-I3 the answer is: 0 nums",
        },
        // ── J. Sentence-start + Punctuation variants ─────────────────────────
        Sample {
            text: "divide 100 by 4 now",
            expect_math: true,
            label: "FZ-J1 sentence-start divide",
        },
        Sample {
            text: "square root of 144 please",
            expect_math: true,
            label: "FZ-J2 sentence-start sqrt",
        },
        Sample {
            text: "the answer is: 42",
            expect_math: false,
            label: "FZ-J3 answer-is-colon 1 num",
        },
        Sample {
            text: "equals hard work every time",
            expect_math: false,
            label: "FZ-J4 equals idiom 0 nums",
        },
        // ── K. Evil Combos ────────────────────────────────────────────────────
        Sample {
            text: "per your request evaluate how many times 3 plus 4 appears in sometimes",
            expect_math: true,
            label: "FZ-K1 mixed evil combo",
        },
    ]
}
...
fn math_pack_fuzz() {
    ...
    for s in &samples {
        ...
        println!(
            "{:<60} {:>8} {:>8} {:>8}",
            s.label, expect_str, got_str, ok_str
        );
    ...
    println!(
        "  (→ guard)             Fixed by ≥2-integer guard in caller — FSE is too coarse alone"
    );
    println!(
        "  (→ suppress)          Needs new Reject rule — guard cannot fix (no numbers present)"
    );
    println!(
        "  (→ suppress-conflict) Reject fires before real math is reached — suppress too broad"
    );
...
fn scan_clause(map: &FseMap, clause: &str) -> bool {
    ...
    match scanner.scan(normalized.as_bytes()) {
        Ok(summary) => {
            if !passes_integer_guard(clause) {
                return false;
            }
...
fn detect_math(map: &FseMap, text: &str) -> bool {
    split_clauses(text)
        .into_iter()
        .any(|clause| scan_clause(map, clause))
}
...
fn math_pack_precision_recall() {
    ...
    if recall >= 0.90 && fpr <= 0.05 {
        ...
        if recall < 0.90 {
            println!(
                "  → Recall {:.1}% is below 90% target — add more positive patterns",
                recall * 100.0
            );
        }
        if fpr > 0.05 {
            println!(
                "  → FPR {:.1}% is above 5% target — add more suppress patterns",
                fpr * 100.0
            );
        }
    }
